...
@AllArgsConstructor
@Slf4j
////////////////스웨거에서 header에 저장한 token 보내도록 설정 
...
public class MemberController {
	...
	///////////////////TODO 4. "refresh-token"을 위한 상수 선언
	
	private final MemberService memberService;

	////////////////토큰 관리를 위해 JWTUtil 선언하기
...
//				headers.add(Refresh_AUTH, refreshToken);
				...
				////// TODO 5. refreshToken을 위한 쿠키 생성 및 설정 하기 
	            
	            
	            ////// TODO 6. response에 쿠키 추가하기 
	...
	public ResponseEntity<?> logout(@PathVariable("userId") String id
		...
		try {
			if (isAuth(id, accessToken)) {
				////// TODO 7. 클라이언트에게 발급한 refreshToken을 삭제하기 
...
//		return new ResponseEntity<Map<String, Object>>(result, headers, status);
	...
	public ResponseEntity<Map<String, Object>> update(@RequestBody Member member,
		...
		HttpStatus status = HttpStatus.OK;
		Map<String, Object> resultMap = new HashMap<>();
////////////////토큰으로 체크하고 안전하면 회원정보를 수정하는 코드 작성
	...
	public ResponseEntity<String> remove(@PathVariable("id") String id,
		...
		String msg = SUCCESS;
		HttpStatus status = HttpStatus.OK;
////////////////토큰으로 체크하고 안전하면 회원을 탈퇴시키는 코드 작성		

...
public class Customer { // top class, enclosing class
	/*
	 * Nested Class: 클래스 내에 선언한 클래스
	 * - 키워드로 무엇이 들어오든 다 받을 수 있다.
	 * */
	class MyClass {
	}
	 ...
	 */
	public Customer() {
		// 코드 재사용을 위해 인자가 다른 생성자를 호출
		this("Uplus", "서울특별시 서초구", 2);
	}
	 ...
	 *  객체의 내용을 문자열로 리턴하는 기능
	 *
	 *  문자열 + 객체, System.out.println(객체) 시 toString()가 호출된다.
	 * */
	@Override
